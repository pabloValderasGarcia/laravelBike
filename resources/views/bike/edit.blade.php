...
@section('content')
        ...
        <h1 style="padding: 12px 0 0 200px">Edit</h1>
        
        <p style="font-size: 15px; 
            margin-left: 192px; padding: 10px">
            Do you want to edit {{ $bike->name }}?
        </p>
